"""Embedded default seed — mirrors frontend DEFAULT_DATA and PRODUCTS."""
...
SECTIONS = {
    ...
    "globalStandards": {
        ...
        "boxes": [
            {"title": "Color Sorting", "desc": "Advanced optical CCD color sorters ensure every grain is perfectly uniform in color, translucent, and clean."},
            {"title": "Triple Polishing", "desc": "Our unique multi-stage water and silk polishing process gives each grain a pearly finish and enhanced shelf life."},
            {"title": "Custom Packaging", "desc": "From luxury burlap to customized BOPP bags and big bulk loads, we offer packaging sizes tailored for global retail."},
            {"title": "Seamless Logistics", "desc": "Our integrated supply chain management and port relations ensure timely deliveries and correct phytosanitary documentation."},
        ],
    },
    "globalFootprint": {
    ...
    "millProcess": {
        ...
        "steps": [
            {"step": "01", "title": "Procurement", "description": "We source directly from the fertile Indus basins, selecting only the highest grade paddy through rigorous field inspections and fair-trade partnerships with generation-linked farmers.", "image": "https://lh3.googleusercontent.com/aida-public/AB6AXuDLVvGgdAsmBzO-VvPWl-c5-TKQcfcZSyX89KZHDK-x-PFiXPxuvcll7zq_LeB1HNedMzQtbAoGCnf_tAaw0xlTSUZEQjPBHSR9ESPrNrhhHvntC-whzCU2qDjN4z6QMFNn0Y3cPfRojPiMuh5le0HOSpctbo-tzznY4-v8qvPjJgIsuw4n4nm4fdHZ-EZ2va6IptS8xBQpc4voh8eg5ZS2y1eopFnbIDJ5TpBd1As87SEzDwKqwSEb6b6iwyMRiY_vvUpUoz1M-10"},
            {"step": "02", "title": "Cleaning & Processing", "description": "Using Buhler-grade technology, grains undergo a multi-stage cleaning process to remove physical impurities, dust, and husks without cracking the delicate pearlescent grain core.", "image": "https://lh3.googleusercontent.com/aida-public/AB6AXuACKG-lspG-EqqXdJe0PQntUcvhmlqk2a4mH2CTdDiQE-vTfNBowb8R1qcJsNyXDgY_dAfLAR1jqHk2OTalQnZ7-QrQqg1lZ6Fi6b9HwAuorScVWMlGijxta9LDaQrGUrYDLi8rZcvbtyelm7ikFcyEPNiWOfYJJeZCEaA0wKBXI0QUUbGoN05YOL9V0XOqBHC3972NrYyYDe7c1BDLArebRqKlx5pFKPPo8VsoFt70v5WHWI-BsJTo2nFejWC5JrDxoewTdDtcFLM"},
            {"step": "03", "title": "Grading & Packaging", "description": "Advanced CCD laser sorters analyze every single grain, checking length consistency and optical color purity. Grains are then nitrogen-flushed and packaged into moisture-sealed bags.", "image": "https://lh3.googleusercontent.com/aida-public/AB6AXuC-1JRltra9UPwcCgyOaowLG6qT2eSN8kSGQVkblK9XKkujEFiFuwMk3VNQJs1N8CzTYVvHjsdVhP8TRVjUIfYjGgQHLwkX6gVYrEcsAezvz1TOHOl2bGM1QXmVKonsw6T1nPDlELpiAIwr6EsKKM1inmAT5BsFWOUcwSGMCHuFb6wtO0H7fzkWom4ITaqwWh_snTApQp7uoBSbM3c85NhJXkIi35lCNLikJJarSCckPbWIh1hrEbO74pC8MhaZ6UFezdsnk5xJVtg"},
            {"step": "04", "title": "Global Export", "description": "From Port Qasim and Karachi Port to ports worldwide, we coordinate the complete logistics chain, maritime freight, and customs documentation for flawless delivery.", "image": "https://lh3.googleusercontent.com/aida-public/AB6AXuCIiQAPb-BQn4uT1fwlwbU3h05lcoQpQe3N-5c2QNk-Mq_r8PkHJEFu1K38P5NRPMFER097zOXuQ1i169M0x2iXyupWvTs40s9nktYCgDlxQC03Td2owqhjrRF5z84_yiz-EVKo16_yNrbuBnnC2JjykEUYyGA2GmGdAZ1Rjnov_WaA5d-UDkBvJup80sZwpzn5WtwXzcDnCUGg0F7CIOZLZzJed_OtQ_4E1gAp_gcCg8Af3iMOOMeWYhn3zJ8qd4MnpvlN0a5JmV4"},
        ],
    },
    "ceoSection": {
        "partners": [
